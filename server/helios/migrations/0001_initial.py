    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "datatype",
                    models.CharField(default="legacy/Election", max_length=250),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "voter_file",
                    models.FileField(
                        max_length=250, null=True, upload_to="voters/%Y/%m/%d"
                    ),
                ),
        ...
        migrations.AddField(
            ...
            name="election",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="helios.Election"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="voter", unique_together=set([("election", "voter_login_id")]),
        ),
        migrations.AlterUniqueTogether(
            name="trustee", unique_together=set([("election", "email")]),
        ),
    ]
