# -*- coding: utf-8 -*-
# Generated by Django 1.11.20 on 2020-01-16 22:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('result_proof', django.contrib.postgres.fields.jsonb.JSONField(null=True)),
        ...
        migrations.AddField(
            model_name='qrcode',
            name='voter',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='helios.Voter'),
        ),
        migrations.AddField(
            model_name='castvote',
            name='voter',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='helios.Voter'),
        ),
        migrations.AddField(
            model_name='auditedballot',
            name='election',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='helios.Election'),
        ),
