...
urlpatterns = [
    ...
    url(r'^e/(?P<election_short_name>[^/]+)$', helios.views.election_shortcut, name=names.ELECTION_SHORTCUT),
    ...
    url(r'^elections/single_ballot_verifier$', views.election_single_ballot_verifier,
